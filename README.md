...
See [email delivery and team management](docs/email-and-team-update.md) for the four required migrations, worker configuration, editable email templates, decision-email workflow, shared invitation deadline and team deletion behavior.
